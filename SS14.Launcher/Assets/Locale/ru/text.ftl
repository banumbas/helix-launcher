...
button-done = Готово!
launcher-themes-title = Темы
launcher-themes-theme = Тема
launcher-themes-theme-desc = Выберите готовую цветовую тему лаунчера или создайте свою.
launcher-themes-custom-colors = Цвета своей темы
launcher-themes-custom-colors-desc = Настройте цвета, которые используются во всём лаунчере.
launcher-themes-background = Цвет фона
launcher-themes-accent = Цвет акцента
launcher-themes-text = Цвет текста
launcher-themes-popup = Цвет всплывающих окон
launcher-themes-gradient-start = Начальный цвет градиента
launcher-themes-gradient-end = Конечный цвет градиента
launcher-themes-reset = Сброс
launcher-themes-import = Импорт JSON
launcher-themes-export = Экспорт JSON
launcher-themes-gradient = Градиентный фон
launcher-themes-gradient-desc = Добавляет мягкий диагональный градиент к фону лаунчера.
launcher-themes-decor = Декоративный узор
launcher-themes-decor-desc = Показывает узор на вкладках и фоне окна входа.
launcher-themes-dark = Тёмная
launcher-themes-light = Светлая
launcher-themes-dark-red = Тёмно-красная
launcher-themes-dark-purple = Тёмно-фиолетовая
launcher-themes-midnight-blue = Полуночно-синяя
launcher-themes-emerald-dusk = Изумрудный сумрак
launcher-themes-copper-night = Медная ночь
launcher-themes-custom = Своя
tab-options-general-tab = Общие
tab-options-resource-packs-tab = Ресурспаки
tab-options-configs-tab = Конфиги
tab-servers-table-mode = Режим
tab-servers-table-map = Карта
tab-servers-table-ping = Пинг
tab-configs-title = Конфиги
tab-configs-desc = Выбирайте YAML-профили кейбиндов: лаунчер применит выбранный профиль перед запуском игры.
tab-configs-open-directory = Открыть папку
tab-configs-import-current = Импорт текущих
tab-configs-clear-selection = Снять выбор
tab-configs-reload = Обновить список
tab-configs-empty = Конфиги кейбиндов не найдены. Добавьте .yml или .yaml в папку конфигов, затем обновите список.
tab-configs-selected = Активен
tab-configs-select = Выбрать
tab-configs-delete = Удалить
tab-resource-packs-header = Ресурспаки
tab-resource-packs-desc = В игру подключаются файлы из Resources/ внутри каждого пака. Если целевой форк не указан, пак подходит для любого форка.
tab-resource-packs-open-directory = Открыть папку ресурспаков
tab-resource-packs-reload = Обновить паки
tab-resource-packs-empty = Ресурспаки не найдены. Создайте папку пака, добавьте meta.json и Resources/, затем обновите список.
tab-resource-packs-enabled = Включено
launcher-themes-font = Шрифт
launcher-themes-font-desc = Выберите встроенный шрифт или загрузите файл .ttf/.otf.
launcher-themes-font-load = Загрузить свой шрифт

# Helix launcher options
tab-options-helix-tab = Helix
tab-options-helix-server-list-title = Отображение списка серверов
tab-options-helix-server-list-desc = Управляет дополнительными полями в списках Избранное и Серверы.
tab-options-helix-show-mode = Показывать текущий режим игры
tab-options-helix-show-map = Показывать текущую карту
tab-options-helix-show-ping = Показывать пинг
tab-options-helix-discord-rpc-title = Discord Rich Presence
tab-options-helix-discord-rpc-desc = Управляет тем, что Discord Rich Presence показывает, пока запущен лаунчер или игра.
tab-options-helix-discord-rpc-enabled = Включить Discord Rich Presence
tab-options-helix-discord-rpc-in-game-title = Пока игра запущена
