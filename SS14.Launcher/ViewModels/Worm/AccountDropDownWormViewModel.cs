...
public sealed class AccountDropDownWormViewModel : ViewModelBase
{
    private readonly MainWindowViewModel _mainVm;
    private readonly DataManager _cfg;
    private readonly AuthApi _authApi;
    private readonly LoginManager _loginMgr;
    private readonly ReadOnlyObservableCollection<WormStoredAccountViewModel> _accounts;
    private readonly LocalizationManager _loc;

    public ReadOnlyObservableCollection<WormStoredAccountViewModel> Accounts => _accounts;
    public bool EnableMultiAccounts => _cfg.ActuallyMultiAccounts;

    [Reactive] public bool IsDropDownOpen { get; set; }

    public AccountDropDownWormViewModel(MainWindowViewModel mainVm)
    {
        _mainVm = mainVm;
