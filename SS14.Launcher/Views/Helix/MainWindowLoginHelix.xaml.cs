...
public partial class MainWindowLoginHelix : UserControl
{
    private readonly LoginManager _loginMgr;
    private readonly LocalizationManager _loc;
    private MainWindowLoginViewModel? _viewModel;

    public MainWindowLoginHelix()
    {
        InitializeComponent();
    ...
    private void UpdateStoredAccountsState(System.Collections.Generic.IReadOnlyCollection<HelixStoredAccountViewModel> accounts)
    {
